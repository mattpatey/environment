...
myKeys =
    [   ((mlp_modMask, xK_v), spawn "amixer -c 0 set PCM 2dB-")
      ...
      , ((mlp_modMask, xK_e), spawn "/usr/bin/emacs")
      , ((mlp_modMask, xK_f), spawn "/usr/bin/thunar")
      , ((mlp_modMask, xK_g), spawn "/usr/bin/firefox")
      , ((mlp_modMask, xK_l), spawn "/usr/bin/xscreensaver-command -lock")
    ]
    ++
