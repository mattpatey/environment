(custom-set-variables
 ...
 '(jabber-alert-muc-hooks (quote (jabber-truncate-muc jabber-muc-scroll)))
 '(jabber-auto-reconnect t)
 '(jabber-history-enabled t)
 '(jabber-mode-line-compact nil)
 '(jabber-mode-line-mode nil)
 '(jabber-post-connect-hooks (quote (jabber-send-current-presence jabber-muc-autojoin jabber-whitespace-ping-start jabber-vcard-avatars-find-current)))
...
(custom-set-faces
 ...
 '(diff-added ((t (:inherit diff-changed :foreground "#77cc77"))))
 '(diff-file-header ((((class color) (min-colors 88) (background dark)) (:weight bold))))
 '(diff-header ((((class color) (min-colors 88) (background dark)) (:foreground "#cccc00"))))
 '(diff-hunk-header ((t (:inherit diff-header :background "#222233" :box (:line-width 1 :color "grey75" :style pressed-button)))))
 '(diff-indicator-added ((t (:inherit diff-added :foreground "#22ff22"))))
 '(diff-removed ((t (:inherit diff-changed :foreground "#cc7777"))))
 '(flymake-errline ((((class color) (background dark)) (:foreground "#ff9999"))))
 '(flymake-warnline ((((class color) (background dark)) (:slant italic))))
 '(font-lock-comment-face ((((class color) (min-colors 8) (background dark)) (:foreground "#777788" :slant italic :height 0.85))))
 '(highlight ((t nil)))
 ...
 '(magit-diff-add ((t (:foreground "#77cc77"))))
 '(magit-diff-del ((t (:foreground "#cc7777"))))
 '(magit-header ((t (:background "#222233"))))
 ...
 '(mode-line-buffer-id ((t (:background "#ffffff" :foreground "#000000" :inverse-video t :weight bold :height 1.3))))
 '(mode-line-emphasis ((t (:weight bold))))
 '(mode-line-inactive ((t (:background "#111111" :foreground "#333333" :height 0.8))))
 '(mumamo-background-chunk-major ((((class color) (min-colors 88) (background dark)) nil)))
 '(mumamo-background-chunk-submode1 ((((class color) (min-colors 88) (background dark)) nil)))
 '(nxml-comment-content ((t (:inherit font-lock-comment-face :foreground "gray"))))
 '(region ((t (:background "#333355"))))
 '(rst-level-1-face ((t (:background "grey45"))) t)
